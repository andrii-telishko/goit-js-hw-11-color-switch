...
var stopBtnRef = document.querySelector('[data-action="stop"]');
...
function changeBodyBgC() {
  var colorBodyBgr = randomIntegerFromInterval(0, _colors.default.length - 1);
  document.body.setAttribute('style', "background-color:".concat(_colors.default[colorBodyBgr]));
}
},{"./colors":"js/colors.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
